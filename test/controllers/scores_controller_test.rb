...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { memo: @score.memo, ratable_id: @score.ratable_id, value: @score.value } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { memo: @score.memo, ratable_id: @score.ratable_id, value: @score.value } }
